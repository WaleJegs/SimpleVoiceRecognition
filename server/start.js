...
module.exports = app
    .use(bodyParser.urlencoded({ limit: 1024 * 1024 * 500, extended: true, parameterLimit: 50000, type: 'application/json' }))
    .use(bodyParser.json({ limit: 1024 * 1024 * 500, type: 'application/json' }))
